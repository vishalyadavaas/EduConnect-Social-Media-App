...
export const createPostLike = async (postLike) => {
 try {
   ...
   console.error("createPostLike error: ", error);
   return { success: false, message: error.message || "failed to create post like" };
...
export const removePostLike = async (postId, userId) => {
  try {
    ...
    console.error("removePostLike error: ", error);
    return { success: false, message: error.message || "failed to remove post like" };
...
export const fetchPostDetails = async (postId) => {
  try {
    ...
    console.log("fetch post error: ", error);
    return { success: false, message: error.message || "Failed to fetch post details" };
  }
};
